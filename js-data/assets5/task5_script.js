(() => {
    ...
    let pictures = [{
            id: 1,
            src: 'Images_3/assets5/task5_1.png',
            data: true
        },
        {
            id: 2,
            src: 'Images_3/assets5/task5_2.png',
            data: false
        },
        {
            id: 3,
            src: 'Images_3/assets5/task5_3.png',
            data: false
        },
        {
            id: 4,
            src: 'Images_3/assets5/task5_4.png',
            data: false
        },
        {
            id: 5,
            src: 'Images_3/assets5/task5_5.png',
            data: true
        },
        {
            id: 5,
            src: 'Images_3/assets5/task5_6.png',
            data: false
        }
    ]

(() => {
    ...
    const input3 = document.querySelector('#task21_3')
    const input4 = document.querySelector('#task21_4')


    const play1 = document.querySelector('.task21_play1')
    const play2 = document.querySelector('.task21_play2')
    const play3 = document.querySelector('.task21_play3')
    const play4 = document.querySelector('.task21_play4')
    const play5 = document.querySelector('.task21_play5')

(() => {
    ...
    checkingTaskBtn.addEventListener('click', () => {
        ...
        baloons.forEach(item => {
            ...
            if (item.classList.contains('task9_orange')) {
            ...
            if (item.classList.contains('task9_white')) {
                if (item.getAttribute('fill') === '#ffffff' || item.getAttribute('fill') === '#FFFFFF' || item.getAttribute('fill') === '#fff' || item.getAttribute('fill') === 'white') {
                    winVar++
                }
            }
        })

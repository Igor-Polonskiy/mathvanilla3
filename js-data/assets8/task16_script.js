(() => {
    ...
    const input1 = document.querySelector('#task16_1')
    const input2 = document.querySelector('#task16_2')
    const input3 = document.querySelector('#task16_3')
    const input4 = document.querySelector('#task16_4')
    const input5 = document.querySelector('#task16_5')

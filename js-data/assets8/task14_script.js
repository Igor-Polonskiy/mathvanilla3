(() => {
    ...
    const input6 = document.querySelector('#task14_6')
    const input7 = document.querySelector('#task14_7')
    const input8 = document.querySelector('#task14_8')
    const input9 = document.querySelector('#task14_9')
    const input10 = document.querySelector('#task14_10')

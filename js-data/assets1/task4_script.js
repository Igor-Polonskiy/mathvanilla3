(() => {
    ...
    const answers = [{
            id: 1,
            data: '1',
            src: 'Images_3/assets1/task4_4.png'
        },
        {
            id: 2,
            data: '1',
            src: 'Images_3/assets1/task4_5.png'

        },
        {
            id: 3,
            data: '1',
            src: 'Images_3/assets1/task4_6.png'

        },
        {
            id: 4,
            data: '2',
            src: 'Images_3/assets1/task4_3.png'

        }, {
            id: 5,
            data: '2',
            src: 'Images_3/assets1/task4_2.png'
        },
        {
            id: 6,
            data: '2',
            src: 'Images_3/assets1/task4_1.png'

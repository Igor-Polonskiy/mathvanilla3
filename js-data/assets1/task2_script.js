(() => {
    ...
    let pictures = [{
            id: 1,
            src: 'Images_3/assets1/task2_1.png',
            data: true
        },
        {
            id: 2,
            src: 'Images_3/assets1/task2_2.png',
            data: true
        },
        {
            id: 3,
            src: 'Images_3/assets1/task2_3.png',
            data: true
        },
        {
            id: 4,
            src: 'Images_3/assets1/task2_4.png',
            data: false
        },
        {
            id: 5,
            src: 'Images_3/assets1/task2_5.png',
            data: false
        }
    ]

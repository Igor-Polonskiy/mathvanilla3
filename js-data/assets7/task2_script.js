(() => {
    ...
    const pictures = [{
            id: 1,
            src: 'Images_3/assets7/task2_1.png',
            text: 'Сколько красных яблок?'
        },
        {
            id: 2,
            src: 'Images_3/assets7/task2_2.png',
            text: 'На рисунке четыре красных яблока.'
        },
        {
            id: 3,
            src: 'Images_3/assets7/task2_3.png',
            text: 'Что изменилось?'
        },
        {
            id: 4,
            src: 'Images_3/assets7/task2_4.png',
            text: 'Добавили ещё одно зелёное яблоко. Четыре да один — это пять.'
        },
        {
            id: 5,
            src: 'Images_3/assets7/task2_5.png',
            text: 'Как ещё можно получить число 5?'
        },
        {
            id: 6,
            src: 'Images_3/assets7/task2_6.png',
            text: 'Можно к трём прибавить два, или к двум прибавить три, или к одному прибавить четыре.'
        },
        {
            id: 7,
            src: 'Images_3/assets7/task2_7.png',
            text: 'А можно прибавлять о одному.'
        }
    ]

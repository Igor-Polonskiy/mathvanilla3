(() => {
    ...
    const drops = document.querySelectorAll('.task8_imgWrapper_img')
    ...
    const answers = [{
            id: 1,
            data: 'Images_3/assets6/task8_1.png'
        },
        {
            id: 2,
            data: 'Images_3/assets6/task8_2.png'
        },
        {
            id: 3,
            data: 'Images_3/assets6/task8_3.png'
        }
    ]
    ...
    document.addEventListener('mouseup', (e) => {
        if (draggingItem) {
            ...
            if (elemBelow.classList.contains("task8_imgWrapper_img") && elemBelow.children.length === 0) {

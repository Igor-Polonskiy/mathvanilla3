(() => {
    ...
    const pictures = [{
            id: 1,
            src: 'Images_3/assets3/task1_1.png',
            text: 'Сколько стульев?'
        },
        {
            id: 2,
            src: 'Images_3/assets3/task1_2.png',
            text: 'На рисунке два стула.'
        },
        {
            id: 3,
            src: 'Images_3/assets3/task1_3.png',
            text: 'Что изменилось?'
        },
        {
            id: 4,
            src: 'Images_3/assets3/task1_4.png',
            text: 'Поставили ещё один стул. Два да один — это три.'
        },
        {
            id: 5,
            src: 'Images_3/assets3/task1_5.png',
            text: 'Что изменилось?'
        },
        {
            id: 6,
            src: 'Images_3/assets3/task1_6.png',
            text: 'Убрали один стул. Три без одного — это два.'
        }
    ]

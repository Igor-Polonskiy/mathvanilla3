(() => {
    ...
    const pictures = [{
            id: 1,
            src: 'Images_3/assets3/task2_1.png',
            text: 'Третий день недели — среда.'
        },
        {
            id: 2,
            src: 'Images_3/assets3/task2_2.png',
            text: 'Третий месяц года — март.'
        },
        {
            id: 3,
            src: 'Images_3/assets3/task2_3.png',
            text: 'Третий месяц осени — ноябрь.'
        }
    ]
